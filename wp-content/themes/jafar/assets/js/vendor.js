...
(function (global, factory) {
  ...
  var version = "1.0.23"; // Clamp a value between a minimum and maximum value
  ...
  var Animate = /*#__PURE__*/function () {
    ...
    var _proto = Animate.prototype; // Advance the animation by the given delta time
  ...
  var Emitter = /*#__PURE__*/function () {
    ...
    _proto.on = function on(event, cb) {
      var _this$events$event,
          _this = this; // Add the callback to the event's callback list, or create a new list with the callback


      ((_this$events$event = this.events[event]) == null ? void 0 : _this$events$event.push(cb)) || (this.events[event] = [cb]); // Return an unsubscribe function
  ...
  var VirtualScroll = /*#__PURE__*/function () {
    function VirtualScroll(element, _ref) {
      ...
      var _ref$wheelMultiplier = _ref.wheelMultiplier,
          ...
          normalizeWheel = _ref$normalizeWheel === void 0 ? false : _ref$normalizeWheel; // Event handler for 'touchstart' event
  ...
  var Lenis = /*#__PURE__*/function () {
    ...
    function Lenis(_temp) {
      ...
      this.onVirtualScroll = function (_ref2) {
        var deltaX = _ref2.deltaX,
            deltaY = _ref2.deltaY,
            event = _ref2.event; // keep zoom feature

        if (event.ctrlKey) return;
        var isTouch = event.type.includes('touch');
        var isWheel = event.type.includes('wheel');
        if (_this.options.gestureOrientation === 'vertical' && deltaY === 0 || // trackpad previous/next page gesture
        ...
        ) return; // catch if scrolling on nested scroll elements
      ...
      window.lenisVersion = version; // if wrapper is html or body, fallback to window
    ...
    _proto.scrollTo = function scrollTo(target, _temp2) {
      ...
      if (this.isStopped && !force) return; // keywords
      ...
      this.animate.fromTo(this.animatedScroll, target, {
        ...
        onUpdate: function onUpdate(value, _ref4) {
          var completed = _ref4.completed; // started

          if (lock) _this2.isLocked = true;
          _this2.isScrolling = true; // updated
...
var Lettering = function () {
  ...
  var Constructor = function Constructor(selector) {
    ...
    var elems = Array.prototype.slice.call(document.querySelectorAll(selector)); // Hashed string to replace line breaks with

    var str = 'eefec303079ad17405c889e092e105b0'; // Public APIs object
