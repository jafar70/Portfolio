...
<div class="m07">
  <div class="container">
    <div class="m07__title">
      <h1 class='banner-title m07__title__text'><?php echo esc_html( the_title() . '.' ); ?></h1>
    </div>

    <div class='m07__meta'>
      <div class="m07__meta__item">
        <p><a href="/portfolio" class='arrow-back'><?php echo esc_html( 'Portfolio' ); ?></a><?php echo esc_html( ' / ' . get_the_title() ); ?></p>
      </div>
    ...
    <?php if( !empty($portfolio_image) ): ?>
      <img data-src="<?php echo $portfolio_image['url']; ?>" alt="<?php echo $portfolio_image['alt']; ?>" class="m07__img mb-40 lazy"/>
    <?php endif; ?>
    ...
    <div class='m07__grid'>
      ...
      <div class="m07__grid__buttons">
            ...
            <?php if( $portfolio_github_link ): ?>
              <a class="button" href='<?php echo $portfolio_github_link; ?>' rel="noopener" target='_blank'><?php echo esc_html( 'View Source Code' ); ?></a>
            <?php else : ?>
      ...
      <div class="m07__grid__nav">
        <?php
          ...
          if($prev){
            ...
            echo '<div class="m07__grid__nav__item m07__grid__nav__item--left"><a href="' . $url . '" title="' . $prev->post_title . '" class="previous-post-link"><span>&#171;</span><p> Previous project</p></a></div>';
          }
      
          if($next) {
            $url = get_permalink($next->ID);            
            echo '<div class="m07__grid__nav__item m07__grid__nav__item--right"><a href="' . $url . '" title="' . $next->post_title . '" class="next-post-link"><p>Next project </p> <span>&#187;<span></a></div>';
          } 
        ?>
      </div>
      </div>
