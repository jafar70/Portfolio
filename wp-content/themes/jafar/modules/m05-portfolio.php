	...
	<div class="container mb-30">
		...
		<div id="portfoliolist" class="m05__list">
			<div class='m05__grid'>
				...
				?>
					<div class="m05__grid__item <?php if ($class_names) { echo ' ' . $class_names;} ?>" data-cat="<?php if ($class_names) { echo ' ' . $class_names;} ?>">
						<a class="m05__portfolio" href="<?php the_permalink(); ?>">
							...
							<div class="m05__portfolio__overlay">
								<h3 class="m05__portfolio__overlay__title"><?php echo esc_html( $title ); ?></h3>
							</div>
						</a>
					</div>
				<?php 
